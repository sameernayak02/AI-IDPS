document.addEventListener('DOMContentLoaded', () => {
    const regForm     = document.getElementById('analystRegForm');
    ...
    regForm.addEventListener('submit', async (e) => {
        ...
        const payload = {
            role: 'Analyst',
            username: formData.get('userid'), // Mapping userid to username
            password: password,
        ...
        try {
            ...
            regSuccess.textContent = 'Analyst account created successfully! Redirecting to login...';
